...
public class DeliveryQuery
{
     ...
     * @return The number of passage points, i.e. one (for the warehouse) plus the number of deliveries to make.
     */
    ...
    /**
     * Gives back the different identifiers of the passage points of a delivery query in an Integer array. The first 
     * element of this array (i.e. index 0) is the warehouse identifier
